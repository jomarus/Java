...
public class Pelota_00 extends Applet implements Runnable, ActionListener {
	...
	public void init(){
		...
		//añado boton 1 y su listener
		add(b1=new Button("Iniciar pelota"));
		b1.addActionListener(this);
				
		//añado boton 2 y su listener
		add(b2=new Button("Parar pelota"));
		b2.addActionListener(this);	
		
		//añado boton 3 y su listener
